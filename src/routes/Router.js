...
const FilterUser = Loadable(lazy(() => import('../views/users/FilterUser')));
...
const ThemeRoutes = [
  {
    ...
    children: [
      ...
      { path: '/user', name: 'user', exact: true, element: <AllUsers /> },
      { path: '/filterUser', name: 'user', exact: true, element: <FilterUser /> },
    ],
  },
  {
    path: '/auth',
